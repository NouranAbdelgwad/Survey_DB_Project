...
<body>
    ...
    <!-- NAVBAR -->
    <?php include 'layout/survey_navbar.php'; ?>
    <!-- MAIN BOX -->
    <div class="container form-wrapper shadow-sm">
        ...
        <h4 class="fw-bold mt-4 mb-4" style="color:#1B263B;">
            How would you rate the overall structure and organization of the course materials?
        </h4>
        ...
        <div class="d-flex justify-content-between mt-5">
            <a href="survey5.php" class="btn btn-dark px-5 py-2 rounded-3">Previous</a>
            <a href="survey7.php" class="btn btn-dark px-5 py-2 rounded-3">Next</a>
        </div>
    </div>
