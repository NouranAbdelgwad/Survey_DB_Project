...
<body>
    ...
    <div class="container form-wrapper shadow-sm">
        ...
        <h4 class="fw-bold mt-4 mb-4" style="color:#1B263B;">
            How well were the learning objectives communicated and achieved?
        </h4>
        ...
        <div class="d-flex justify-content-between mt-5">
            <a href="survey4.php" class="btn btn-dark px-5 py-2 rounded-3">Previous</a>
            <a href="survey6.php" class="btn btn-dark px-5 py-2 rounded-3">Next</a>
        </div>
    </div>
